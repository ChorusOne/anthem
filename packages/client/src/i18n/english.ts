...
export type ENGLISH =
  ...
  | readonly [
      ...
      {
        fees: JSX.Element;
        delegationAmount: JSX.Element;
        validatorAddress: JSX.Element;
      },
    ]
  | readonly [
  ...
  | readonly [
      ...
      {
        fees: JSX.Element;
        sourceValidator: JSX.Element;
        destinationValidator: JSX.Element;
      },
    ]
  | readonly [
